...
class Activator
{
	...
	*/
    ...
    public function get_ready()
    {
        ...
        $results[
            'flush_rewrite_rules'
        ] = update_option('wpshopify_should_flush_rewrite_rules', 1);
	...
	*/
    ...
    {
        $default_page_title = 'WP Shopify Products';
    ...
    {
        $default_page_title = 'WP Shopify Collections';
        $existing_page = \get_page_by_title($default_page_title);
    ...
    public function maybe_create_default_pages()
    {
        ...
        if ($created_successfully) {
            if (
                ...
                $this->DB_Settings_General->update_column_single(
                    ['url_products' => \wp_make_link_relative(get_permalink($results['products']))],
                    ['id' => 1]
                );
            }
            ...
            if (
                ...
                $this->DB_Settings_General->update_column_single(
                    [
                        'url_collections' => \wp_make_link_relative(get_permalink(
                            $results['collections']
                        )),
                    ],
                    ['id' => 1]
